...
namespace WorkTechHub.App_Code
{
    public class RandomCodeGenerator
    {
        ...
        public string GetCaptchaCode()
        {
            ...
            Code = "";
            Random r = new Random();
            ch = (char)r.Next(65, 90); //capital alphabet
            Code = Code + ch;
            ch = (char)r.Next(49, 57); //digit
            Code = Code + ch;
            ch = (char)r.Next(97, 122); //small alphabet
            Code = Code + ch;
        ...
        internal  string [] GetCaptchaImgAndCode()
        {
            ...
            string FolderPath = HttpContext.Current.Server.MapPath("/content/Captcha");
